...
$sql = "SELECT * FROM AniProject WHERE is_approved = 0";
...
<body>
    <header>
        ...
        <nav>
            <ul class="menu">
                <li><a href="AdminHuman.php" >Human</a></li>
                <li><a href="AdminEnvironment.php">Environment</a></li>
                <li><a href="AdminAnimal.php" class="active">Animals</a></li>
    ...
    <div class="two">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo '
                <div id="animal-' . $row['id'] . '" class="block1">
                    <div class="project-card">
                        <h2>' . htmlspecialchars($row['title']) . '</h2>
                        <img src="' . htmlspecialchars($row['picture']) . '" alt="Animal Image">
                        ...
                        <div class="project-details">
                            ...
                            <p><strong>Condition:</strong> ' . htmlspecialchars($row['con']) . '</p>
                        </div>
                        <a href="tel:+94771234567" class="button">Contact Us</a>
                        <a href="' . htmlspecialchars($row['email']) . '" class="email">Email: ' . htmlspecialchars($row['email']) . '</a>
                    </div>
                    <div class="tf">
                        <form method="post" action="process_event_Animal.php">
            ...
            echo "<p>No pending animal projects found.</p>";
        }
