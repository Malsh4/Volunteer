...
<body>
    ...
    <div class="main">
        <header>
            ...
            <nav>
                <ul class="menu">
                    <li><a href="index.php" class="active">Human</a></li>
        ...
        <div class="event-cards">
            ...
            // Query to fetch only approved events from the 'HumProject' table
            $sql = "SELECT * FROM HumProject WHERE is_approved = 1";
