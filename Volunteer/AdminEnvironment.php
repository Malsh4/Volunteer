...
$sql = "SELECT * FROM EnvProject WHERE is_approved = 0";
    ...
    <header>
        ...
        <nav>
            <ul class="menu">
                ...
                <li><a href="AdminEnvrionment.php" class="active">Environment</a></li>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div id="event-' . $row['id'] . '" class="block1">
                        ...
                        <div class="tf">
                            <form method="post" action="process_event_Environment.php">
